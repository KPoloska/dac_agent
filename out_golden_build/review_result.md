...
- Generated at: `2026-01-02T04:29:33.775316+00:00`
...
- `S2.0-01-TXT` **MET** (major) — Evidence PDF has extractable text: Chapter1.pdf
  ...
  - evidence: `{"file": "daisy_test_data\\Chapter1.pdf", "page_count": 10, "text_chars": 0, "image_count": 20, "ocr_enabled": false, "ocr_required": true, "ocr_available": false, "ocr_attempted": false}`
- `S2.0-02-TXT` **MET** (major) — Evidence PDF has extractable text: Chapter2-3.pdf
  - MVP warning: OCR required: PDF appears scanned/image-based (no/low extractable text).
  - evidence: `{"file": "daisy_test_data\\Chapter2-3.pdf", "page_count": 11, "text_chars": 0, "image_count": 22, "ocr_enabled": false, "ocr_required": true, "ocr_available": false, "ocr_attempted": false}`
- `S2.0-03-TXT` **MET** (major) — Evidence PDF has extractable text: Provisioning & Assignment of Access.pdf
  - evidence: `{"file": "daisy_test_data\\Provisioning & Assignment of Access.pdf", "page_count": 3, "text_chars": 4460, "image_count": 3, "ocr_enabled": false, "ocr_required": false, "ocr_available": false, "ocr_attempted": false}`
- `S2.0-04-TXT` **MET** (major) — Evidence PDF has extractable text: Review and Approval of Access.pdf
  - evidence: `{"file": "daisy_test_data\\Review and Approval of Access.pdf", "page_count": 3, "text_chars": 2633, "image_count": 3, "ocr_enabled": false, "ocr_required": false, "ocr_available": false, "ocr_attempted": false}`
- `S2.0-05-TXT` **MET** (major) — Evidence PDF has extractable text: Recertification.pdf
  - evidence: `{"file": "daisy_test_data\\Recertification.pdf", "page_count": 2, "text_chars": 2668, "image_count": 2, "ocr_enabled": false, "ocr_required": false, "ocr_available": false, "ocr_attempted": false}`
...
- `S4.1-02` **MET** (major) — Functional Area relevancy recorded (yes/no)
  - evidence: `{"value": "yes"}`
- `S4.1-03` **NOT_MET** (major) — Entitlement composition upload decision recorded (yes/no)
  - Expected yes/no but value is missing or not parseable.
...
- `S4.2-01` **NOT_MET** (major) — CIF (critical & important function) recorded (yes/no)
  - Expected yes/no but value is missing or not parseable.
...
- [4.1] Entitlement composition upload decision recorded (yes/no): Expected yes/no but value is missing or not parseable.
- [4.2] CIF (critical & important function) recorded (yes/no): Expected yes/no but value is missing or not parseable.
